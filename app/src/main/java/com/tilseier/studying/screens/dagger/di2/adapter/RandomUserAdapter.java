package com.tilseier.studying.screens.dagger.di2.adapter;
...
import com.tilseier.studying.screens.dagger.di2.model.Result;
...
public class RandomUserAdapter extends RecyclerView.Adapter<RandomUserAdapter.RandomUserViewHolder> {
    ...
    public RandomUserAdapter(DaggerActivity3 mainActivity, Picasso picasso) {
